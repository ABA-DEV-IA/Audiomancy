...
export function Footer() {
  ...
  return (
    <footer className="bg-brume-cosmique border-t border-amethyste-magique py-4">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0">
          {/* Description */}
          <div className="text-center md:text-left">
            <p className="text-eclat-ether text-sm max-w-md">
            ...
            {socialLinks.map((social) => {
              ...
              return (
                <Button
                  ...
                  variant="ghost"
                  size="icon"
                  className="hover:bg-encre-astrale transition-colors h-8 w-8"
          ...
          <div className="text-center md:text-right">
            <p className="text-eclat-ether text-sm">© 2025 AUDIOMANCY. Tous droits réservés.</p>
          </div>
        </div>
      </div>
    </footer>
