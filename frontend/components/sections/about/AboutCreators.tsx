...
export function AboutCreators({ creators }: Props) {
  return (
    <div>
      <h2 className="text-2xl font-bold text-eclat-ether text-center mb-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {creators.map((creator, i) => {
          ...
          return (
            ...
            >
              <Card className="bg-brume-cosmique border-amethyste-magique hover:border-rose-alchimique transition-colors h-full">
                <CardContent className="p-6 text-center flex flex-col justify-start min-h-[300px]">
                  ...
                  <div>
                    ...
                    <p className="text-feu-anciens font-medium mb-3">{creator.role}</p>
                    <p className="text-eclat-ether text-sm line-clamp-4">{creator.description}</p>
                  </div>
                </CardContent>
              </Card>
            </a>
