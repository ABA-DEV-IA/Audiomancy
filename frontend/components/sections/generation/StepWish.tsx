...
// import VoiceInput from './VoiceInput';  // [DÉSACTIVÉ] Azure Speech TTS - Migration locale
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center text-center space-y-8 bg-[#2B2B2B] p-8">
      ...
      <div className="max-w-lg w-full">
        ...
        {/* [DÉSACTIVÉ] Bouton micro Azure Speech - Migration locale */}
        ...
        <div className="flex flex-col sm:flex-row w-full gap-4 mt-6">
          <Button
            onClick={onNext}
            disabled={!wish.trim()}
            className="w-full bg-gradient-to-r from-[#6A0DAD] to-[#A45EE5] 
