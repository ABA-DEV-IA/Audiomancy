# Audiomancy Monitoring Stack

Stack complète de monitoring, logging et chaos engineering pour l'application Audiomancy, déployable en local et sur VPS avec WireGuard VPN.
